...
public class Java8FunctionalTest {
	 ...
	 * 함수형 프로그래밍은 순수함수-> 입력이 같으면 출력은 항상 동일하다는 패러다임을 갖고 있습니다.
	 * 따라서 stateless 한 특성을 갖고 있습니다.(이는 병렬적 프로그래밍에 이점을 줍니다.)
	...
	public void test_lambdaExpressionTest() throws Exception {
		...
		/*
		 * Java 8 이전
		 * - Comparator 인터페이스믐 사실 함수처럼 사용되지만 익명 클래스로 생성해야 하는 불편함이 있었다.
